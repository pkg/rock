...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.rocks.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".rocks" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".rocks")
	}
